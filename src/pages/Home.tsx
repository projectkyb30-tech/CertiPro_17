          ...
          <CardContent className="px-0 pt-0">
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              {isLoading ? (
                ...
                <div className="col-span-full flex items-center justify-center py-12">
                  <div className="max-w-md w-full bg-[var(--color-card)] dark:bg-[var(--color-card-dark)] border border-[var(--color-border)] dark:border-[var(--color-border-dark)] rounded-[var(--radius-lg)] p-8 mx-4 text-center">
                    <div className="w-14 h-14 mx-auto mb-4 rounded-2xl bg-[var(--color-muted)] dark:bg-[var(--color-muted-dark)] flex items-center justify-center text-primary">
