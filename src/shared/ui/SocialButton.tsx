...
export const SocialButton: React.FC<SocialButtonProps> = ({ provider, onClick }) => {
  ...
  return (
    <button
      onClick={onClick}
      className="w-full flex items-center justify-center gap-3 px-3 py-3 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-50 transition-all active:scale-[0.98] group"
    ...
    >
      ...
      <span className="text-gray-700 font-medium text-[15px] leading-5 tracking-tight font-sans">
